...
\titulo{Um modelo de Programação Inteira para o problema de alocação de professores da UFC-Quixadá}
\data{2016}
\local{Quixadá -- Ceará}
...
\membrodabancadoisies{Universidade Federal do Ceará - UFC}
\membrodabancatres{Prof. Me. Paulo Henrique Macedo de Araujo}
...
\begin{document}
	...
	\input{elementos-textuais/modelo-para-o-papd}
